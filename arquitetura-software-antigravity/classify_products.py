...
def classify_products(input_file="amazon_products_local.json", output_file="amazon_classified.json"):
    ...
    for p in products:
        ...
        # VR e Acessórios Específicos devem passar antes de "headset" genérico (que puxaria VR Headsets para Áudio)
        elif any(x in title for x in ["cabo", "cable", "usb", "suporte", "base", "carregamento", "ssd", "unidade de disco", "vr2", "portal remote", "lcd", "quest"]):
